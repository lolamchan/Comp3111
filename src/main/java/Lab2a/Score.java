package Lab2a;
public class Score {
    /* A class contains constructor[C], attributes[A] and methods[M]. */ /* [A] Attribute List */
    double Quiz, MidTExam, FinalExam, Score;
    char grade;
    String comment;
    /* [C] Constructor: to initialize value to the object through parameter. */ Score(){
        Quiz = 0;
        MidTExam = 0;
        FinalExam = 0;
    }
    ...
    double getScore() {
        Score = 0.2*Quiz + 0.3*MidTExam + 0.5*FinalExam; return Score;
    }
    char getGrade() {
